...
const cacheName = 'DemoGitHub-2021-02-24 14:27:28.106155'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'DemoGitHub'.length) === 'DemoGitHub') {
